...
| `Norse.Abstractions.Backend` | `Norse.Primitives`, `Norse.Abstractions.Contracts` | Shared server-side contracts (serialization seam — `ISerializer`/`ISerializerProvider`/`NamingStrategy`; egress contracts under `.Egress` namespace) |
