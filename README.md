...
| [`Norse.Abstractions.Components`](src/Abstractions.Components) | `Abstractions.Contracts`, ASP.NET Core Components | Razor component base abstractions ([`AsyncComponentBase`](src/Abstractions.Components/AsyncComponentBase.cs), [`IAppShellLayout`](src/Abstractions.Components/Primitives/IAppShellLayout.cs), [`IDashboardWidget`](src/Abstractions.Components/Primitives/IDashboardWidget.cs)) plus the outcome-form seam hoisted from Heimdall ([`OutcomeFormComponentBase`](src/Abstractions.Components/OutcomeFormComponentBase.cs) and the [`ServerValidation/`](src/Abstractions.Components/ServerValidation) bridge) — MAUI/WASM-safe, no server-side types; the non-form outcome dispatch sibling [`OutcomeComponentBase`](src/Abstractions.Components/OutcomeComponentBase.cs) |
| [`Norse.Abstractions.Backend`](src/Abstractions.Backend) | `.Contracts` | The read contract ([`IReadRepository<TView>`](src/Abstractions.Backend/IReadRepository%7BTView%7D.cs), [`IViewBearer<TView>`](src/Abstractions.Backend/IViewBearer%7BTView%7D.cs)), the [serialization seam](src/Abstractions.Backend/Serialization), and the [key custody seam](src/Abstractions.Backend/Keys) |
| [`Norse.Abstractions.Web.Server`](src/Abstractions.Web.Server) | `.Backend`, FluentValidation | The [mediator law](src/Abstractions.Web.Server/Mediator) ([`IRequest`](src/Abstractions.Web.Server/Mediator/IRequest.cs)/[`ICommandRequest`](src/Abstractions.Web.Server/Mediator/ICommandRequest.cs)/[`IQueryRequest`](src/Abstractions.Web.Server/Mediator/IQueryRequest.cs), [`ISender`](src/Abstractions.Web.Server/Mediator/ISender.cs), [`IRequestHandler`](src/Abstractions.Web.Server/Mediator/IRequestHandler.cs), [`IBehavior`](src/Abstractions.Web.Server/Mediator/IBehavior.cs), [`CommandRequest`](src/Abstractions.Web.Server/Mediator/CommandRequest.cs), [`CommandRequestValidator`](src/Abstractions.Web.Server/Mediator/CommandRequestValidator.cs)), the [gRPC facade](src/Abstractions.Web.Server/Facade) ([`GrpcControllerBase`](src/Abstractions.Web.Server/Facade/GrpcControllerBase.cs), [`ProblemErrorEntry`](src/Abstractions.Web.Server/Facade/ProblemErrorEntry.cs)), and [`IDeferredSignIn`](src/Abstractions.Web.Server/DeferredSignIn/IDeferredSignIn.cs) |
