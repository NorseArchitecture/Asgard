...
|---|---|---|
| `Norse.Abstractions.Contracts` | none | `Outcome<T>` (+ `Problem`/`ErrorCategory`/`BoolResponse`/`Unit`), `IRequest`/`ICommandRequest`/`IQueryRequest` marker family |
