...
public readonly record struct Unit
{
	...
	[SuppressMessage("Performance", "CA1805:Do not initialize unnecessarily", Justification = "Unit has no meaningful state; the static field documents the single inhabited value.")]
